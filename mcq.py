# -*- coding: utf-8 -*-
"""
Created on Mon Feb 22 20:31:19 2021
...
def is_far(words_list,currentword,thresh,normalized_levenshtein):
    ...
    for word in words_list:
        score_list.append(normalized_levenshtein.get_levenshtein_distance(word.lower(),currentword.lower()))
...
def filter_phrases(phrase_keys,maximum,normalized_levenshtein ):
    ...
    if len(phrase_keys)>0:
        ...
        for ph in phrase_keys[1:]:
            ...
            if len(filtered_phrases)>=maximum:
                break
